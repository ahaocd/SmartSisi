...
# 获取所有源文件，但排除不需要的文件系统驱动
file(GLOB_RECURSE SOURCES ${LVGL_ROOT_DIR}/src/*.c ${LVGL_ROOT_DIR}/src/*.cpp)

# 排除不需要的文件系统驱动，避免编译错误
list(FILTER SOURCES EXCLUDE REGEX ".*lv_fs_littlefs\\.c$")
list(FILTER SOURCES EXCLUDE REGEX ".*lv_fs_fatfs\\.c$")
list(FILTER SOURCES EXCLUDE REGEX ".*lv_fs_posix\\.c$")
list(FILTER SOURCES EXCLUDE REGEX ".*lv_fs_win32\\.c$")
list(FILTER SOURCES EXCLUDE REGEX ".*lv_fs_memfs\\.c$")
...
if(LV_MICROPYTHON)
  ...
  idf_component_register(SRCS ${SOURCES} ${DEMO_SOURCES}
      INCLUDE_DIRS ${LVGL_ROOT_DIR} ${LVGL_ROOT_DIR}/src ${LVGL_ROOT_DIR}/../
                   ${LVGL_ROOT_DIR}/demos
      REQUIRES  esp_timer esp_driver_ppa esp_mm log main)
endif()
