...
LOGS_ROOT = Path(util.ensure_log_dir("tools", "tiktok_batch"))

def create_logger(log_name: str, file_name: str):
    """
...
douyin_logger = create_logger('douyin', 'douyin.log')
tencent_logger = create_logger('tencent', 'tencent.log')
xhs_logger = create_logger('xhs', 'xhs.log')
tiktok_logger = create_logger('tiktok', 'tiktok.log')
bilibili_logger = create_logger('bilibili', 'bilibili.log')
kuaishou_logger = create_logger('kuaishou', 'kuaishou.log')
baijiahao_logger = create_logger('baijiahao', 'baijiahao.log')
xiaohongshu_logger = create_logger('xiaohongshu', 'xiaohongshu.log')
