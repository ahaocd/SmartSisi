...
class DouyinApi(object):
    ...
    def getKey(self, url):
        ...
        try:
            r = requests.get(url=url, headers=douyin_headers, proxies={'http': None, 'https': None})
        ...
        if "/user/" in urlstr:
            ...
            res = requests.get(url, headers=douyin_headers, proxies={'http': None, 'https': None})
    ...
    def getAwemeInfoApi(self, aweme_id):
        ...
        while True:
            try:
                ...
                raw = requests.get(url=jx_url, headers=douyin_headers, proxies={'http': None, 'https': None}).text
    ...
    def getUserInfoApi(self, sec_uid, mode="post", count=35, max_cursor=0):
        ...
        while True:
            try:
                ...
                res = requests.get(url=url, headers=douyin_headers, proxies={'http': None, 'https': None})
    ...
    def getLiveInfoApi(self, web_rid: str):
        ...
        while True:
            try:
                ...
                response = requests.get(live_api, headers=douyin_headers, proxies={'http': None, 'https': None})
