from app.gpt.prompt import BASE_PROMPT, SEO_METADATA, BRAND_TAGS_PROMPT
...
def get_brand_tags_format():
    """获取品牌标签识别 prompt"""
    return BRAND_TAGS_PROMPT
