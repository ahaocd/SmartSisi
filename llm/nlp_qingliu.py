...
class BigModel:
    ...
    def __init__(self):
        ...
        try:
            ...
            pass
        cache_root = cfg.cache_root or os.path.join(os.path.dirname(os.path.abspath(__file__)), "cache_data")
        self.conversation_file = os.path.join(cache_root, "bigmodel_conversation_data.json")
